...
//foregroundColor: Colors.grey,
  ...
  // shareGroup(){
  //   dynamicLinkProvider()
  //       .createLink('group' + widget.groupID.toString())
  //       .then((value) {
  //     final box = context.findRenderObject() as RenderBox?;
  //     Share.share(
  //       "You are invited to join my DRBA group " +
  //           widget.groupName +
  //           ' \n \n' +
  //           value,
  //       sharePositionOrigin:
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
            ...
            //     onPressed: () {
            //       GoRouter.of(context).goNamed('Welcome');
            //     }
            // ),
                ...
                children: [
                  ...
                  Expanded(
                    child: Container(
                      ...
                      height: 1000 + 2 * descriptiontxtSize!.height,
