                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child: SelectableText.rich(
                                        ...
                                        TextSpan(
                                          children: extractText(newsdata!._newsStory!),
                                          style: TextStyle(
                                            color: Colors.black,
                                            fontFamily: "NexaBold",
                                            fontSize: 20,
                                    ...
                                    child: ElevatedButton(
                                      onPressed: ()  async {
                                        if (_translated.translatedText=='') {
                                          _translated = await _translation.translate(text: newsdata!._newsStory!, to: Localizations.localeOf(context).toString());
                                  ...
                                  itemBuilder: (context, index) {
                                    return
                                      ...
                                      title:
                                          ...
                                          //   onTap: () {
                                          //     Navigator.of(context).push(MaterialPageRoute(
                                          //         builder: (context) =>  profilePage(receiverName: newsdata!.chatList[index].chatName!,
                                          //             receiverID:newsdata!.chatList[index].chatID! )));
                                          //   },
                                          //   child: Text(newsdata!.chatList[index].chatName!+': ' ,
                                          //       style: TextStyle(
                                          //         color: Colors.blue,
                                          //         fontFamily: "NexaBold",
                                          //         fontSize: 20,
                                        ...
                                        TextSpan(
                                          text:
                                              newsdata!.chatList[index].chatName!,
