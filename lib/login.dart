                      ...
                      double.infinity
                          ...
                          child: Column(
                            children: [
                              ...
                              Text(
                                  AppLocalizations.of(context).signinorsignupwith +
                                            ...
                                            if (_phoneController.text.isEmpty ||
                                              ...
                                              showErrorMessage(
                                                  ...
                                                  AppLocalizations.of(context)
                                                      .enterPhoneNumber);
                                            } else if (isOnlyNumber(_phoneController
                                                .text
                                                .replaceAll('+', ''))) {
                        ...
                        GestureDetector(
                          ...
                          onTap: () async {
                                    ...
                                    child: Text(AppLocalizations.of(context).asGuest,
                                        style: TextStyle(
                                          color: Colors.black54,
                                          fontWeight: FontWeight.w600,
                                          fontSize: 20,
                                ...
                                child: DropdownButton<String>(
                                  ...
                                  onChanged: (String? value) {
                                    ...
                                    Home.of(context)?.setLocale(
                                        Locale.fromSubtags(languageCode: _Locale));
                                  },
                                ),
                              ),
                            ],
  ...
  Widget SigninWithEmail() {
    return Column(
      ...
      children: [
        ...
        // Text(
        //   AppLocalizations.of(context)
        //       .enterthepasswordtoSigninorpressRegisterforanewaccount,
        //   style: TextStyle(
        //     color: Colors.black,
        //     fontFamily: "NexaBold",
        //   ),
