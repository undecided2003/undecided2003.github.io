...
class AuthService{
  ...
  signInWithGoogle(String language) async{
   ...
   final gauthsigin = await FirebaseAuth.instance.signInWithCredential(credential);
    // print (gUser.id);
...
//print('exists!');
            ...
            await FirebaseFirestore.instance.collection("Students").doc(_firebaseAuth.currentUser!.uid)
                    .set(
                    {
