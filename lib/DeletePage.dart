...
class _DeletePageState extends State<DeletePage> with SingleTickerProviderStateMixin {
  ...
  async {
    ...
    if (tabController.index==1&& screenState!=1) {
      screenState =  0;
      containerHeight = await 620;
    } else if (tabController.index==0 ){
      screenState =  2;
      containerHeight = await 715;
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(AppLocalizations.of(context).youwillbemissed +'\n',
                          style: TextStyle(
                              fontSize: 25,
                      ...
                      //       onPressed: signIn,
                      //       style: ElevatedButton.styleFrom(
                      //         backgroundColor: Colors.grey[350], // Background color
                      //       ),
                      ...
                      Row(
                        ...
                        children: [
                          SquareTile(
                              onTap: () async {
                                await AuthService().signInWithGoogle('en');
                                await FirebaseFirestore.instance
                                    .collection('Students')
                                    .doc(userID)
                                    .get()
                          ...
                          SquareTile(
                              onTap: () async {
                                await AuthService().signInWithApple1('en');
                                await FirebaseFirestore.instance
                                    .collection('Students')
                                    .doc(userID)
                                    .get()
