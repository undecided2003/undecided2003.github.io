...
if(DateTime(dateTime.year, dateTime.month, dateTime.day, _time.hour, _time.minute).isBefore(
    ...
    if ((locationController.text.isNotEmpty&& _lat!=0.01 && _lng!=0.01) ||linkController.text.isNotEmpty) {
      ...
      await FirebaseFirestore.instance
        ...
        if (Users.exists) {
          ...
          chatMessageList.add(AppLocalizations.of(context).pleaseaskquestionsorsharecommentshere);
          ...
          sendEventPushNotification(Users.get('Name'), isOnline,
              docRef.id, groupMembersIDList, eventNameController.text,groupName );
          showErrorMessage(context, AppLocalizations.of(context).youaddedanevent+docRef.id);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBars( AppLocalizations.of(context).createaDharmaEvent,'', context),
                              ...
                              child: TextFormField(
                                ...
                                onTap: () async {
                                  String locationroute = await Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                        builder: (context) =>
                                            SearchLocationScreen('From New Event')),
                                  );
